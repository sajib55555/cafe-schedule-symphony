      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <Card className="p-8 bg-white shadow-lg rounded-lg">
            ...
            <Button 
              className="w-full"
              onClick={() => handleSubscribe('TRIAL_PRICE_ID')} // Replace with actual Stripe price ID
            >
              Start Free Trial
            </Button>
          </Card>
          ...
          <Card className="p-8 bg-white shadow-lg rounded-lg border-primary">
            ...
            <Button 
              className="w-full"
              onClick={() => handleSubscribe('PREMIUM_PRICE_ID')} // Replace with actual Stripe price ID
            >
              Upgrade to Premium
            </Button>
          </Card>
